<template>
  <div class="aboutslc">
    ...
    <div class="vision">
      <div class="row">
        <div class="col-lg-6 col-md-12 col-sm-12 vision-text" data-aos="fade-right" data-aos-duration="2000">
          <span class="vision-text-span">
            <h1>Our <span class="vision-hijau">Vision</span></h1>
            <p>
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">
                <ul>
                  <li>
                    Organizing globalization socialization for rural youth so that they are aware of their inability to face global challenges
                  </li>
                  <li>
                    Organizing life science education for free.
                  </li>
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">
                <ul>
                  <li>
                    Improving the appreciation and implementation of local wisdom
                  </li>
                  <li>
                    Increase awareness and use of information technology
                  </li>
                </ul>
              </p>
            </div>
...
@import url("https://fonts.googleapis.com/css2?family=Montserrat:wght@300;400&family=Poppins:wght@200;300;400;500;600;700&display=swap");
...
.mission .card {
        ...
        box-shadow: rgba(0, 0, 0, 0.349) 0px 7px 29px 0px;
}
...
.team-dekstop .founder .col-5:first-child{
  text-align: end;
}

.team-dekstop .founder .col-5:last-child{
  text-align: start;
}

.team-dekstop .founder img{
  width:184px;
  height:184px;
  border-radius: 100%;
  margin-bottom: 20px;
...
.team-dekstop .director .col-3:first-child{
  text-align: end;
}

.team-dekstop .director .col-3:last-child{
  text-align: start;
}

.team-dekstop .director .col-3 img{
  width:131px;
  height:131px;
  border-radius: 100%;
  margin-bottom: 20px;
...
.team-dekstop .secretary .col-4:last-child{
  text-align: start;
}

.team-dekstop .secretary .col-4 img{
  width:131px;
  height:131px;
  border-radius: 100%;
  margin-bottom: 20px;
