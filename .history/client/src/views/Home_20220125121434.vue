       ...
       <div class="our-program">
         ...
         <div class="content">
           ...
           <div class="testimonial">
            ...
            <div class="wrapper">
              <div class="column4">
               <img src="https://asset.kompas.com/crops/skk_fzrMQFRN7DRjYRdyUzTGxDA=/0x14:733x503/750x500/data/photo/2020/09/22/5f69de4196b5e.png">
               <img src="https://asset.kompas.com/crops/skk_fzrMQFRN7DRjYRdyUzTGxDA=/0x14:733x503/750x500/data/photo/2020/09/22/5f69de4196b5e.png">
              </div>
              <div class="column4">
               <img src="https://asset.kompas.com/crops/skk_fzrMQFRN7DRjYRdyUzTGxDA=/0x14:733x503/750x500/data/photo/2020/09/22/5f69de4196b5e.png">
...
@keyframes slide{
    ...
    30%{
        trasn: translateX(-100%);
    }
    50%{
        trasn: translateX(-100%);
    }
    55%{
        trasn: translateX(-200%);
    }
    75%{
        trasn: translateX(-200%);
    }
    80%{
        trasn: translateX(-300%);
    }
    100%{
        trasn: translateX(-300%);
    }
