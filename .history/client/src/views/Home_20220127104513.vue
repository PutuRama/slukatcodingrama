       ...
       <div class="row3-program">
         ...
         <div class="col program-img">
           ...
           <div class="col program">
            ...
            <button class="col button-program"><a href="#">Find Out More</a><i class="fas fa-arrow-circle-right" style="font-size: 30px; color: white; margin-left: 30px;"></i></button>
           </div>
        ...
        <div class="blog">
          ...
          <div class="blog-picture">
           <div class="blog-icon">
          <img src="https://asset.kompas.com/crops/skk_fzrMQFRN7DRjYRdyUzTGxDA=/0x14:733x503/750x500/data/photo/2020/09/22/5f69de4196b5e.png" alt="">
          <h5>Slukat Learning Center | <span class="blog-span">18/01/2022</span> </h5>
